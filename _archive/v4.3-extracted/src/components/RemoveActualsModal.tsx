...
const selectCls =
  'appearance-none bg-white border border-slate-300 rounded-md text-sm px-2.5 py-1.5 pr-7 focus:outline-none focus:border-slate-500 cursor-pointer';
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-200 bg-slate-50 rounded-b-2xl shrink-0">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-bold text-white bg-[#e60000] rounded-lg hover:bg-red-700 transition-colors disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-2"
          >
            <Trash2 size={14} />
            Remove Actuals
          </button>
